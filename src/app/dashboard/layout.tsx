...
const links = [
  ...
  { name: "alet dialog", href: "alert-dialog" },
                ...
                <ul className="space-y-2 pb-2">
                  ...
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:text-slate-400 dark:hover:bg-slate-700"
                      >
